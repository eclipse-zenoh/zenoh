...
use crate::advanced_cache::{ke_liveliness, KE_PREFIX, KE_STAR};
...
#[zenoh_macros::unstable]
fn handle_sample(
    states: &mut HashMap<EntityGlobalId, InnerState>,
    wait: bool,
    sample: Sample,
...
struct PeriodicQuery {
    ...
    statesref: Arc<Mutex<(HashMap<EntityGlobalId, InnerState>, bool)>>,
