...
async fn test_liveliness_issue_1470() {
    ...
    let router0 = {
        let mut c = zenoh::Config::default();
        c.set_id(ZenohId::from_str("a0").unwrap().into()).unwrap();
        c.listen
            .endpoints
    ...
    let router1 = {
        let mut c = zenoh::Config::default();
        c.set_id(ZenohId::from_str("a1").unwrap().into()).unwrap();
        c.listen
            .endpoints
    ...
    let peer = {
        let mut c = zenoh::Config::default();
        c.set_id(ZenohId::from_str("b").unwrap().into()).unwrap();
        c.listen
            .endpoints
    ...
    let client0 = {
        let mut c = zenoh::Config::default();
        c.set_id(ZenohId::from_str("c0").unwrap().into()).unwrap();
        c.connect
            .endpoints
            .set(vec![PEER_ENDPOINT.parse::<EndPoint>().unwrap()])
            .unwrap();
    ...
    let client1 = {
        let mut c = zenoh::Config::default();
        c.set_id(ZenohId::from_str("c1").unwrap().into()).unwrap();
        c.connect
            .endpoints
            .set(vec![PEER_ENDPOINT.parse::<EndPoint>().unwrap()])
            .unwrap();
