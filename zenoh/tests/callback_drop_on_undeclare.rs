...
async fn test_callback_drop_on_undeclare_subscriber() {
    ...
    let (session1, session2) = ztimeout!(create_peer_client_pair("tcp/127.0.0.1:20001"));
...
async fn test_callback_drop_on_undeclare_queryable() {
    ...
    let (session1, session2) = ztimeout!(create_peer_client_pair("tcp/127.0.0.1:20002"));
...
async fn test_callback_drop_on_undeclare_liveliness_subscriber() {
    ...
    let (session1, session2) = ztimeout!(create_peer_client_pair("tcp/127.0.0.1:20003"));
    let (cb, n) = create_callback::<Sample>();
...
async fn test_callback_drop_on_undeclare_querier() {
    ...
    let (session1, session2) = ztimeout!(create_peer_client_pair("tcp/127.0.0.1:20004"));
...
async fn test_callback_drop_on_undeclare_publisher() {
    ...
    let (session1, session2) = ztimeout!(create_peer_client_pair("tcp/127.0.0.1:20005"));
...
async fn test_callback_drop_on_undeclare_liveliness_get() {
    ...
    let (session1, session2) = ztimeout!(create_peer_client_pair("tcp/127.0.0.1:20006"));
