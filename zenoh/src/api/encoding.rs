...
impl Encoding {
    ...
    /// Data serialized with zenoh serialization format.
    ///
    /// Constant alias for string: `"zenoh/serialization"`.
    pub const ZENOH_SERIALIZATION: Encoding = Self(zenoh_protocol::core::Encoding {
        id: 2,
        schema: None,
    });
    /// A zenoh error.
    ...
    const ID_TO_STR: phf::Map<EncodingId, &'static str> = phf_map! {
        0u16 => "zenoh/bytes",
        1u16 => "zenoh/string",
        2u16 => "zenoh/serialization",
        3u16 => "zenoh/error",
        4u16 => "application/octet-stream",
        5u16 => "text/plain",
        6u16 => "application/json",
        7u16 => "text/json",
        8u16 => "application/cdr",
        9u16 => "application/cbor",
        10u16 => "application/yaml",
        11u16 => "text/yaml",
        12u16 => "text/json5",
        13u16 => "application/python-serialized-object",
        14u16 => "application/protobuf",
        15u16 => "application/java-serialized-object",
        16u16 => "application/openmetrics-text",
        17u16 => "image/png",
        18u16 => "image/jpeg",
        19u16 => "image/gif",
        20u16 => "image/bmp",
        21u16 => "image/webp",
        22u16 => "application/xml",
        23u16 => "application/x-www-form-urlencoded",
        24u16 => "text/html",
        25u16 => "text/xml",
        26u16 => "text/css",
        27u16 => "text/javascript",
        28u16 => "text/markdown",
        29u16 => "text/csv",
        30u16 => "application/sql",
        31u16 => "application/coap-payload",
        32u16 => "application/json-patch+json",
        33u16 => "application/json-seq",
        34u16 => "application/jsonpath",
        35u16 => "application/jwt",
        36u16 => "application/mp4",
        37u16 => "application/soap+xml",
        38u16 => "application/yang",
        39u16 => "audio/aac",
        40u16 => "audio/flac",
        41u16 => "audio/mp4",
        42u16 => "audio/ogg",
    ...
    const STR_TO_ID: phf::Map<&'static str, EncodingId> = phf_map! {
        "zenoh/bytes" => 0u16,
        "zenoh/string" => 1u16,
        "zenoh/serialization" => 2u16,
        "zenoh/error" => 3u16,
        "application/octet-stream" => 4u16,
        "text/plain" => 5u16,
        "application/json" => 6u16,
        "text/json" => 7u16,
        "application/cdr" => 8u16,
        "application/cbor" => 9u16,
        "application/yaml" => 10u16,
        "text/yaml" => 11u16,
        "text/json5" => 12u16,
        "application/python-serialized-object" => 13u16,
        "application/protobuf" => 14u16,
        "application/java-serialized-object" => 15u16,
        "application/openmetrics-text" => 16u16,
        "image/png" => 17u16,
        "image/jpeg" => 18u16,
        "image/gif" => 19u16,
        "image/bmp" => 20u16,
        "image/webp" => 21u16,
        "application/xml" => 22u16,
        "application/x-www-form-urlencoded" => 23u16,
        "text/html" => 24u16,
        "text/xml" => 25u16,
        "text/css" => 26u16,
        "text/javascript" => 27u16,
        "text/markdown" => 28u16,
        "text/csv" => 29u16,
        "application/sql" => 30u16,
        "application/coap-payload" => 31u16,
        "application/json-patch+json" => 32u16,
        "application/json-seq" => 33u16,
        "application/jsonpath" => 34u16,
        "application/jwt" => 35u16,
        "application/mp4" => 36u16,
        "application/soap+xml" => 37u16,
        "application/yang" => 38u16,
        "audio/aac" => 39u16,
        "audio/flac" => 40u16,
        "audio/mp4" => 41u16,
        "audio/ogg" => 42u16,
