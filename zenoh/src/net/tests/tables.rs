...
fn base_test() {
    ...
    let face = router.new_session(primitives, Bound::north());
...
fn multisub_test() {
    ...
    let primitives = Arc::new(DummyPrimitives {});
    let face0 = router.new_session(primitives, Bound::north());
...
fn client_test() {
    ...
    let face0 = router.new_session(primitives0.clone(), Bound::north());
    ...
    let face1 = router.new_session(primitives1.clone(), Bound::north());
    ...
    let face2 = router.new_session(primitives2.clone(), Bound::north());
...
fn get_best_key_test() {
    ...
    let primitives = Arc::new(DummyPrimitives {});
    let face1 = router.new_session(primitives.clone(), Bound::north());
    let face2 = router.new_session(primitives.clone(), Bound::north());
    let face3 = router.new_session(primitives, Bound::north());
...
fn big_key_expr() {
    ...
    let primitives = Arc::new(DummyPrimitives {});
    let face = router.new_session(primitives.clone(), Bound::north());
