...
impl HatPubSubTrait for Hat {
    ...
    fn compute_data_route(
        ...
        for mres in matches.iter() {
            ...
            // FIXME(fuzzypixelz): this is an ugly hack that should be removed
            // once router hats no longer need to manager peer/client faces.
            if self.bound.is_south() {
