...
use crate::{
    ...
    net::routing::{
        ...
        hat::{HatPubSubTrait, InterestProfile, SendDeclare, Sources},
        router::Direction,
        RoutingContext,
    },
};
...
impl HatPubSubTrait for Hat {
    fn handle_shared_subscription(
        ...
        self.handle_subscription(tables, src, id, res, sub_info, send_declare);
    }
    ...
    fn compute_data_route(
        ...
        for mres in matches.iter() {
            ...
            for (sid, context) in &mres.face_ctxs {
                if context.hat[self.bound].subs.is_some() && context.face.whatami == WhatAmI::Client
                {
