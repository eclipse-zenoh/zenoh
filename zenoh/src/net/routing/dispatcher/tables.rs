...
// impl Tables {
//     pub fn hat_ref<T: Any>(&self) -> &T {
//         (&self.hat as &dyn Any).downcast_ref().unwrap()
//     }

//     pub fn hat_mut<T: Any>(&mut self) -> &mut T {
//         (&mut self.hat as &mut dyn Any).downcast_mut().unwrap()
//     }

//     pub fn hat_dyn(&self) -> &(dyn HatTrait + Send + Sync) {
//         &*self.hat
//     }

//     pub fn data(&self) -> &TablesData {
//         &self.data
//     }

//     pub fn data_mut(&mut self) -> &mut TablesData {
//         &mut self.data
//     }
// }
