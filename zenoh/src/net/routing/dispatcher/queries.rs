...
pub(crate) fn get_session_matching_queryables(
    ...
    // REVIEW(fuzzypixelz): are we sure that we always want to check the south hat(s)
...
pub(crate) fn disable_matches_query_routes(tables: &mut TablesData, res: &mut Arc<Resource>) {
