...
use crate::sealed::net::primitives::{McastMux, Mux, Primitives};
use crate::sealed::net::routing::interceptor::{InterceptorTrait, InterceptorsChain};
use std::any::Any;
...
impl FaceState {
    ...
    pub(crate) fn new(
        ...
        primitives: Arc<dyn crate::sealed::net::primitives::EPrimitives + Send + Sync>,
