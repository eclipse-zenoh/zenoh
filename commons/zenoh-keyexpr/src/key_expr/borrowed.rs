...
impl keyexpr {
    ...
    // tags{rust.keyexpr.new, api.keyexpr.create.checked}
    ...
    // tags{rust.keyexpr.autocanonize, api.keyexpr.create.autocanonize}
    ...
    /// tags{rust.keyexpr.intersects, api.keyexpr.intersects}
    ...
    // tags{rust.keyexpr.includes, api.keyexpr.includes}
    ...
    // tags{rust.keyexpr.relation_to, api.keyexpr.relation_to}
    ...
    // tags{rust.keyexpr.join, api.keyexpr.join}
    ...
    // tags{rust.keyexpr.is_wild, api.keyexpr.is_wild}
    ...
    /// ```
    // tags{rust.keyexpr.get_nonwild_prefix, api.keyexpr.get_nonwild_prefix}
    ...
    /// );
    /// ```
    // tags{rust.keyexpr.strip_prefix, api.keyexpr.strip_prefix}
    ...
    /// Much like [`core::str::from_utf8_unchecked`], this is memory-safe, but calling this without maintaining
    /// [`keyexpr`]'s invariants yourself may lead to unexpected behaviors, the Zenoh network dropping your messages.
    // tags{rust.keyexpr.from_slice_unchecked, api.keyexpr.create.unchecked}
