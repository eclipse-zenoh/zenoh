...
/// - I: Infrastructure If I==1 then the error is related to the infrastructure
...
pub mod flag {
    ...
    pub const I: u8 = 1 << 6; // 0x40 Reserved      if I==1 then the error is related to the infrastructure
