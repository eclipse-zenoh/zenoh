...
/// [`NetworkMessage`](crate::network::NetworkMessage). I.e., the total length of the
/// serialized [`NetworkMessage`](crate::network::NetworkMessage) (s) MUST be smaller
/// than the maximum batch size (i.e. 2^16-1) and the link MTU.
/// The [`Frame`] message is used as means to aggregate multiple
/// [`NetworkMessage`](crate::network::NetworkMessage) in a single atomic message that
