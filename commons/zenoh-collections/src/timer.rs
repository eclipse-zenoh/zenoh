...
impl Timer {
    pub fn new(blocking: bool) -> Timer {
        // Create the channels
...
mod tests {
    ...
    fn timer() {
        ...
        async fn run() {
            ...
            sleep(to_elapse + interval).await;
