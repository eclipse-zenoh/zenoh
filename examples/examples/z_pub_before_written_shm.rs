...
async fn main() -> zenoh::Result<()> {
    ...
    for idx in 0..u32::MAX {
        ...
        let mut allocated_promise = promise.alloc().unwrap();
        ...
        // fill allocated memory with data
        ...
        println!(
            "Put SHM Data ('{}': '{}')",
            path,
            String::from_utf8_lossy(&allocated_promise[0..slice_len])
        );
