...
use zenoh_protocol::core::{PeerId, QueryConsolidation, QueryTarget, ResKey, SubInfo, ZInt};
...
impl OwnedPrimitives {
    pub fn new(primitives: Arc<dyn Primitives + Send + Sync>) -> OwnedPrimitives {
        OwnedPrimitives { primitives }
    }
    ...
    pub async fn data(self, reskey: ResKey, reliable: bool, info: Option<RBuf>, payload: RBuf) {
        self.primitives
            .data(&reskey, reliable, &info, payload)
            .await
    }
    pub async fn query(
        self,
        ...
        self.primitives
            .query(&reskey, &predicate, qid, target, consolidation)
            .await
    }
    pub async fn reply_data(
        self,
        qid: ZInt,
        source_kind: ZInt,
        replier_id: PeerId,
        ...
        self.primitives
            .reply_data(qid, source_kind, replier_id, reskey, info, payload)
            .await
    }
    ...
    pub async fn pull(
        ...
        self.primitives
            .pull(is_final, &reskey, pull_id, &max_samples)
            .await
    }
