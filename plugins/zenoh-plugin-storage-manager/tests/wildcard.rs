...
async fn test_wild_card_in_order() {
    ...
    put_data(
        ...
        "wild/test/*",
        "1",
        Timestamp::from_str("7054123566570568799/BC779A06D7E049BD88C3FF3DB0C17FCC")
            .unwrap(),
    )
    .await;
    ...
    put_data(
        ...
        "wild/test/a",
        "2",
        Timestamp::from_str("7054123570865536095/BC779A06D7E049BD88C3FF3DB0C17FCC")
            .unwrap(),
    )
    .await;
    ...
    put_data(
        ...
        "wild/test/*",
        "4",
        Timestamp::from_str("7054123832858541151/BC779A06D7E049BD88C3FF3DB0C17FCC")
            .unwrap(),
    )
    .await;
    ...
    delete_data(
        &session,
        "wild/test/*",
        Timestamp::from_str("7054170209915403359/BC779A06D7E049BD88C3FF3DB0C17FCC")
            .unwrap(),
    )
    .await;
